...
-- ----------------------------
BEGIN;
INSERT INTO `s_student_info` VALUES (5, '20190577', '201906189753', 2, '张大鹏', '200207198679887', 'zhangtianyou@qq.com',
                                     '英语', '1', '汉族', '团员', '9876765', '18811345555', '0', 1, NULL, 1, '北京', '啥层次',
                                     0, '1986-10-11 00:00:00', '补考三次没过', '2022-04-05 12:21:20', 1, '2022-04-06 15:24:55', 1);
...
CREATE TABLE `sys_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3181 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='系统日志';
